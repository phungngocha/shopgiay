    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(
                        request -> request.requestMatchers("/login-v2/**" ,"/client/**","/cart/**","/admin/poin/**","/cart-detail/**","/admin/promotion","/admin/voucher","/ws/**", "/client/ai/**", "/admin/product-detail/search").permitAll()

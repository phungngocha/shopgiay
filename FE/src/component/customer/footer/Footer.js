            ...
            <Row justify={"space-between"}>
              <Col span={12}>
                <div className="category-footer1">
                  © 2025 <Link style={{ color: "#ff4400" }}>BEESNEAKER</Link>.
                  ALL RIGHTS RESERVED | 0343307590
                </div>
                <div className="category-footer1">
                  Phùng Ngọc Hà - D16CNPM2 - Trường đại học Điện Lực<br></br>
                  Địa chỉ: 235 Hoàng Quốc Việt, Cổ Nhuế, Bắc Từ Liêm, Hà Nội, Việt Nam
                </div>
                <div className="category-footer1">
